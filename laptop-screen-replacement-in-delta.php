        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <h2 class="m-0">laptop screen replacment in delta</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <ul class="referLink">
                        <li><a href="#">Data Recovery Services Delta – Hard Drive Data Recovery</a></li>
                        <li><a href="#">MacBook Screen Replacement</a></li>
                        <li><a href="#">MacBook Keyboard Repair</a></li>
                        <li><a href="#">Computer Malware Removal Delta – Trojan Removal</a></li>
                        <li><a href="#">Apple MacBook Logic Board Repair</a></li>
                    </ul>
