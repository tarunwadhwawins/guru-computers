            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <h3>Our Other Computer Repair Services:</h3>
                        <ul class="referLink">
                            <li><a href="<?php echo $url; ?>services/data-recovery-services-delta">Data Recovery Services Delta – Hard Drive Data Recovery</a></li>
                            ...
                            <li><a href="<?php echo $url; ?>services/virus-spyware-malware-adware-removal">Computer Malware Removal Delta – Trojan Removal</a></li>
