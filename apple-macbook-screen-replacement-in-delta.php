        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <h2 class="m-0">macbook screen replacment in delta</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <p>MacBook screen cracked or shattered? Guru Computers provide the best MacBook Screen Replacement in <a href="javascript:void(0)"><span class="textt">Delta </span></a> , BC. At Guru Computers, we repair MacBooks of all generations.</p>
                    <h2>APPLE MACBOOK SCREEN REPLACEMENT IN DELTA</h2>
                    <p>At Guru Computers, we do things the right way. The most common repair on an Apple <a href="javascript:void(0)"><span class="textt"> MacBook</span></a> or a Windows laptop is LCD retina replacement. It may have cracked, or you see vertical
                        lines on it. </p>
                    <p>Do not worry as we have the tools and experience to restore your device to its original state within a short time frame. You can rely on Guru Computers to offer competitive pricing on <a href="javascript:void(0)"><span class="textt"> OEM </span></a>                        parts that are most suitable for your device. </p>
                    ...
                    <div class="product-listing">
                        <ul>
                            ...
                            <li>Dim <a href="javascript:void(0)"><span class="textt-theme"> LCD screen </span></a> due to liquid damage.</li>
                        </ul>
                    </div>
